...
const create_imagerie_dto_1 = require("./dto/create-imagerie.dto");
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ImagerieController.prototype, "findByPatient", null);
exports.ImagerieController = ImagerieController = __decorate([
    (0, common_1.Controller)('prescriptions/imagerie'),
