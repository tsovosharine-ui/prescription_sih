...
__decorate([
    (0, common_1.Get)('permanent/:idPermanent'),
    __param(0, (0, common_1.Param)('idPermanent')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PatientController.prototype, "findByIdPermanent", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
